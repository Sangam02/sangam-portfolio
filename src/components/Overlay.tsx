    ...
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
        ...
        >
            <div className="text-center">
                <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-4">Sangam Gupta.</h1>
                <p className="text-xl md:text-2xl font-light text-gray-300">Software Development Engineer · Python & MERN</p>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">Robotics dashboards, <br/><span className="text-blue-500">geospatial</span> systems & real-time data.</h2>
            </div>
        </motion.div>
        ...
        >
            <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-bold leading-tight">React, MongoDB, <span className="text-purple-500">Mapbox</span> & Docker in production.</h2>
            </div>
        </motion.div>
    </div>
  );
