...
const skills = [
  {
    category: "Languages",
    items: ["Python", "JavaScript (ES6+)", "SQL", "C++", "TypeScript"],
  },
  {
    category: "Frameworks & stacks",
    items: ["Django", "Flask", "React.js", "Next.js", "Node.js", "Express.js", "Redux", "Tailwind CSS"],
  },
  {
    category: "Data, maps & platform",
    items: [
      "MongoDB",
      "MySQL",
      "Mapbox GL JS",
  ...
  },
  {
    ...
    items: ["Docker", "Git / GitHub", "Postman", "Azure", "Android Studio", "ADB", "Raspberry Pi", "SSL/TLS"],
  },
];
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
            Python & MERN stack, geospatial tooling, and shipping production systems for robotics and the web.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {skills.map((group, idx) => (
            ...
            >
              <h3 className="text-xl font-bold text-blue-300 mb-6 uppercase tracking-wider">{group.category}</h3>
