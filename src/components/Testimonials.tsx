...
const TESTIMONIALS = [
  {
    quote:
      "Sangam shipped our fleet analytics views on schedule—the Mapbox integration and MongoDB aggregations made complex robot state easy to reason about for clients.",
    name: "Engineering lead",
    role: "Robotics & software",
    initials: "EL",
  },
  {
    quote:
      "Reliable on real-time pipelines and Docker deploys; he communicates clearly across backend, robotics, and client teams.",
  ...
  {
    quote:
      "Strong Python and MERN fundamentals—turns ambiguous requirements into working dashboards and APIs.",
    name: "Technical peer",
  ...
  {
    quote:
      "The PWA/TWA work for our Android footprint showed attention to production details—JWT, SSL, and packaging were handled end to end.",
    name: "Platform stakeholder",
    role: "Mobile & edge deployment",
    initials: "PS",
  },
];
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
       ...
       <div className="container mx-auto px-6 mb-16 text-center relative z-10">
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
                Highlights from collaborations—add your own review anytime.
            </p>
