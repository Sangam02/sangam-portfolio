    ...
    <section className="relative z-20 bg-[#0a0a0a] py-32 px-4 md:px-12 overflow-hidden" id="contact">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-md leading-relaxed">
              Based in Noida, U.P. Open to high-impact SDE roles and meaningful collaborations in full-stack, data, and geospatial product work.
            </p>

            <div className="flex flex-col gap-6 mb-12">
              <a href="mailto:sangamgupta.dev@gmail.com" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                ...
                <span className="text-lg">sangamgupta.dev@gmail.com</span>
              </a>
              <a href="tel:+919125390163" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-white/10 transition-colors">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                </div>
                <span className="text-lg">+91 91253 90163</span>
              </a>
              
              <div className="flex items-center gap-4">
                 <SocialLink href="https://github.com/Sangam02" icon={<GithubIcon />} label="GitHub" />
                 <SocialLink href="https://linkedin.com/in/sangam-gupta-2ab7a7205" icon={<LinkedinIcon />} label="LinkedIn" />
              </div>
            </div>

            <a 
              href="/api/resume" 
              download="Sangam_Gupta_Resume.pdf"
        ...
        <footer className="mt-24 pt-8 border-t border-white/5 text-center text-gray-500 font-mono text-sm">
           <p>&copy; {new Date().getFullYear()} Sangam Gupta. All rights reserved.</p>
        </footer>
      </div>
    </section>
  );
