...
const ARTICLES = [
  {
    title: "MongoDB time series & GeoJSON at fleet scale",
    excerpt:
      "Lessons from piping millions of records and geospatial queries into React dashboards—aggregation design, indexes, and what broke first in production.",
    category: "Data",
    readTime: "8 min read",
  ...
  {
    title: "Mapbox GL JS for robot state on the map",
    excerpt:
      "Why we chose Mapbox for street-level context, how GeoJSON layers stayed performant, and tips for syncing live telemetry to the UI.",
    category: "Maps",
    readTime: "6 min read",
  ...
  {
    title: "PWA, TWA, and shipping to Android hardware",
    excerpt:
      "Packaging dashboards as installable experiences—JWT, SSL/TLS, ADB workflows, and aligning web constraints with robotics field kits.",
    category: "Platform",
    readTime: "7 min read",
